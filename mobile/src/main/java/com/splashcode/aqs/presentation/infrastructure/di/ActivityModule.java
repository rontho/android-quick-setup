...
import com.splashcode.aqs.data.event.bus.GuavaEventBus;
...
public class ActivityModule {
    ...
    UserInfoProxy provideUserInfoProviderProxy(final EventBus eventBus, final BackEndDataProviderFactory eventBusResponseProviderFactory){
        return new UserInfoProviderProxy(eventBus, eventBusResponseProviderFactory);
    }

    @Provides
    EventBus provideEventBusAdapter(){
